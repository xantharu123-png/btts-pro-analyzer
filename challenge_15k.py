...
def _conservative_validation_map(
    ...
    for spec in market_specs():
        ...
        combined[spec.key] = ValidationMetrics(
            prediction_version=(valid_metrics[0].prediction_version
                if all(metric.prediction_version == valid_metrics[0].prediction_version
                       for metric in valid_metrics) else None),
