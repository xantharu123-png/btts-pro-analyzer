...
Version 2 contains the actual unrounded joint distributions and calibration
recipes. Historical version 1 remains a separate scalar-marginal contract.
...
def capture_football_original(*, inputs, model, raw_probabilities,
    ...
    payload = {
        "schema": 2, "kind": "football-original-market-calculation-v2",
        ...
        "distribution_capture": _json_value(model["distribution_capture"], issues),
