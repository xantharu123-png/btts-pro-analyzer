...
**Fortsetzung 8. September 2026 – aktuelle Priorität:** Die Nutzerfreigaben für Spezifikation, Unteragenten-Ausführung und isolierte Arbeitskopie liegen vor; nicht erneut abfragen. Der separat geprüfte Karten-Quellstand `f82d7aeea2e42d81affa2c4389cb377f2293af5c` erklärt Auswahlen direkt sichtbar aus gebundenen Modellfakten und nennt ein Gegenrisiko. Nachweise: `docs/audits/2026-09-08-kartenanalyse.md` und `.superpowers/sdd/2026-09-08-kartenanalyse/independent-review.md` (1.795 Tests, 11 Skips, 97 Untertests; unabhängiger Fokus 313/26; vier gerenderte Bildschirmbreiten). Produktion beim letzten Vorabcheck noch auf `b3afc478a07fa0d67509e2bef0a9c05766bdb077`; GitHub-/VPS-Stand und tatsächlichen Kontext-Refresh nach Veröffentlichung neu belegen. Die Timer deployen nicht. Tennis-Rebuild und Wettfinder-Ergebnisverarbeitung hatten eigene Fehler; ein UI-Release behebt diese nicht.

**Separater Kontextausbau, weiterhin offen:** In `.worktrees/kontextmodell-20260907` sind A1–A3 auf `16d9c4e88435017c5841e613b9cd91670313813a` geprüft und auf dem Featurebranch gesichert. A4 liegt mit Rennbedingungs-Fix `156ba46` lokal vor; das unabhängige Re-Review läuft. Maßgeblich sind dort `.superpowers/sdd/2026-09-07-kontextmodell-umsetzung/progress.md` und die aufgabenweisen Berichte. B1–D5, empirische Wirkung und Betriebsfreigabe sind nicht erledigt. Der Karten-Release enthält diesen unfertigen Ausbau nicht. Cricket bleibt ausgenommen. Die älteren folgenden Angaben „Wahl steht aus/alle Aufgaben offen“ beschreiben den früheren Planungsstand, nicht die aktuelle Fortsetzung.
...
**Neuer Auftrag – Kontextmodell ohne Cricket:** Architektur und schriftliche Spezifikation `docs/superpowers/specs/2026-09-07-kontextmodell-design.md` sind ausdrücklich freigegeben (7. September: „Spezifikation freigegeben“). Der ausführbare Plan liegt unter `docs/superpowers/plans/2026-09-07-kontextmodell-umsetzung.md`, mit vier verlinkten Teilplänen und 20 prüfbaren Aufgaben. Nächster Schritt: Ausführung ab A1–A4 (getrennte ATP/WTA-Stände), danach vorrangig Fußballverletzungen und Tennisbelastung. Die Wahl zwischen aufgabenweiser Unteragenten-Ausführung und direkter Ausführung steht noch aus. Noch keine Produktionsimplementierung oder Effektaktivierung dieses Ausbaus; alle Aufgaben sind offen. Cricket bleibt ausgenommen. Nicht mit der abgeschlossenen technischen Auditkorrektur verwechseln. Die Spezifikations-/Planänderungen sind reine Dokumentation und erfordern kein funktionales VPS-Deployment.
